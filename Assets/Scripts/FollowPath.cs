...
public class FollowPath : MonoBehaviour
{
    ...
    public MovementPath MyPath; // Reference to MovementPath used
    ...
    public void Start()
    {
        ...
        //Get the next point in the path to move to (Gets the Default first value)
    ...
    public void Update()
    {
        ...
        //Check to see of you are close eough to the next point to start moving to the following one
