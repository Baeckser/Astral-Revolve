...
public class MovementPath : MonoBehaviour
{
    ...
    {
        //Make sure that your sequence has points in it
        //abnd that there are at least two points to constitute a path
...
//*************************************PAUSES HERE****************************************//
            ...
            //For Looping path you must mive the index when you reach
            //the beginning or end of the PathSequence to loop the path
            if(PathType == PathTypes.loop)
            {
